...
static vector<shared_ptr<Blob<Dtype> > > padded_feature;
static vector<shared_ptr<Blob<Dtype> > > cos_window;
static vector<shared_ptr<Blob<Dtype> > > masked_feature;
static vector<shared_ptr<Blob<Dtype> > > raw_feature;
static vector<shared_ptr<Blob<Dtype> > > raw_feature_tmp;
static vector<shared_ptr<Blob<Dtype> > > first_layer_col;
static vector<shared_ptr<Blob<Dtype> > > first_layer_top_data;
static vector<shared_ptr<Blob<Dtype> > > second_layer_template1;
static vector<shared_ptr<Blob<Dtype> > > second_layer_col_buff;
static vector<shared_ptr<Blob<Dtype> > > second_layer_tmp1;
static vector<shared_ptr<Blob<Dtype> > > second_layer_top_data;
static vector<shared_ptr<Blob<Dtype> > > second_layer_weight_diff;
static vector<shared_ptr<Blob<Dtype> > > second_layer_tmp3;
static vector<shared_ptr<Blob<Dtype> > > second_layer_tmp4;
static vector<shared_ptr<Blob<Dtype> > > second_layer_bottom_diff;
static vector<shared_ptr<Blob<Dtype> > > first_layer_weight_diff;
...
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::padded_feature;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::cos_window;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::masked_feature;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::raw_feature;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::raw_feature_tmp;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::first_layer_col;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::first_layer_top_data;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_template1;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_col_buff;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_tmp1;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_top_data;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_weight_diff;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_tmp3;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_tmp4;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::second_layer_bottom_diff;
template <typename Dtype>
vector<shared_ptr<Blob<Dtype> > >Layer<Dtype>::first_layer_weight_diff;
