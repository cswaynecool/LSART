...
void WtftenthLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void WtftenthLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void WtftenthLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(WtftenthLayer);
#endif

INSTANTIATE_CLASS(WtftenthLayer);
